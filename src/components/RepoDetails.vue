<script>
    ...
    methods: {
        fetchData: function () {
            this.loading = true
            fetch(`https://api.github.com/repos/donsalvy/${this.$route.params.id}`, {
            headers: {
            ...
            fetch(`https://api.github.com/repos/donsalvy/${this.$route.params.id}/branches`, {
                headers: {
                    Accept: "application/json"
                },
            })
            ...
            fetch(`https://api.github.com/repos/donsalvy/${this.$route.params.id}/deployments`, {
                headers: {
                    Accept: "application/json"
                },
            })
...
<template>
    <div id="repodetail">
        ...
        <div v-else class="repodetail-card">
            ...
            <p v-else>Live site: <a :href="`https://donsalvy.github.io/${details.name}`">donsalvy.github.io/{{ details.name }}</a></p>
